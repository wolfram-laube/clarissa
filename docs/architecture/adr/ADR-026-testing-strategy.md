> ⚠️ **DEPRECATED** — Diese ADR wurde als company-level BW-ADR-005 in [ops/adr](https://gitlab.com/wolfram_laube/blauweiss_llc/ops/adr) migriert (2026-03-12). Bitte BW-ADR-005 als maßgebliche Referenz verwenden.
>
