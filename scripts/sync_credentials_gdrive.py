...
# Target: CLARISSA/config/ folder
TARGET_FOLDER_ID = config['gdrive']['clarissa']['config_folder_id']

with open(SA_KEY_PATH, 'r') as f:
    sa_key = json.load(f)
print(f"Service Account: {sa_key.get('client_email')}")
print(f"Target folder: CLARISSA/config/ ({TARGET_FOLDER_ID})")
...
print("Credentials synced to CLARISSA/config/")
